...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        world.agents[0].state.p_pose = np.asarray([(d/2)*cos(angle), (d/2)*sin(angle), pi/3])
        world.agents[1].state.p_pose = np.asarray([(d/2)*cos(angle+pi), (d/2)*sin(angle+pi), pi/3])
        world.agents[0].state.p_pos  = world.agents[0].state.p_pose[:2]
        world.agents[1].state.p_pos  = world.agents[1].state.p_pose[:2]
        print(world.agents[1].state.p_pos)
