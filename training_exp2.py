...
class PheroTurtlebotPolicy(object):
    ...
    def __init__(self, sess, ob_space, ac_space, nbatch, nsteps, reuse=False, deterministic = False): #pylint: disable=W0613
        ...
        self.pdtype = make_pdtype(ac_space[0])
        self.num_obs = 13
...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        self.dones = [False] * self.env.n #20201130 num_robots -> n
        ...
        for i in range(self.env.n): # 20201130 num_robots -> n
            lastgaelam = 0
...
def main():
    env = make_env('experiment2_TCDS') # 20201130 mpe env
