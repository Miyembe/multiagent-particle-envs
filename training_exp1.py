...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        for _ in range(self.nsteps):
            ...
            self.env.render() #20201201 render 
...
class PPO:
    ...
    def learn(self):
        ...
        logger_ins = logger.Logger('/home/swn/Seongin/Software/multiagent-particle-envs-master/log', output_formats=[logger.HumanOutputFormat(sys.stdout)])
        ...
        for update in range(1, nupdates+1):
            ...
            if update % log_interval == 0 or update == 1:
                ...
                sio.savemat('/home/swn/Seongin/Software/multiagent-particle-envs-master/log/MATLAB/step_reward_{}.mat'.format(time_str), {'data':step_reward},True,'5',False,False,'row')
...
def main():
    env = make_env('experiment1_TCDS') # 20201130 mpe env
