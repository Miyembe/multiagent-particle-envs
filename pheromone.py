...
class Node():
    ...
    def __init__(self, phero):
        ...
        self.sock_receiver.initalize_receiver(9998) # the 9999 is the port you can change it with your own.
    ...
    def posToIndex(self, x, y):
        ...
        x_tmp = round(x, round_dp) # round the position value so that they fit into the centre of the cell.
    ...
    def pheroCallback(self):
        ...
        for i in range(3):
            for j in range(3):
                phero_val.append(self.pheromone.getPhero(x_index+i-1, y_index+j-1))
